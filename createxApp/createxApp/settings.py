"""
Django settings for createxApp project.
...
SECRET_KEY = 'django-insecure-p&(ee$h7%yd!1(%-g%blc9e=pd7i3vs$pbgn!7u-(#r**v=)v-'
...
WSGI_APPLICATION = 'createxApp.wsgi.application'
